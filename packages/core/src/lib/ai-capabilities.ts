...
export const PROVIDERS: ProviderMetadata[] = [
    ...
    chatModels: [
      {
        ...
        description: 'Most capable model. Extended thinking, web search, tool search.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
      ...
      },
      {
        ...
        description: 'Best balance of intelligence and speed. Extended thinking support.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
      ...
      },
      {
        ...
        description: 'Fast and efficient. Good for high-volume tasks.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
      ...
      },
      {
        ...
        description: 'Previous generation flagship. Excellent reasoning.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
      ...
      },
      {
        ...
        description: 'Balanced performance. Tool use and web search support.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
      ...
      },
      {
        ...
        description: 'Extended thinking support. Good for complex reasoning.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
      ...
      },
      {
        ...
        description: 'Excellent for coding, analysis, and complex tasks.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
...

  {
    ...
    // Exploration models - include all text generation models plus larger options
    explorationModels: [
      {
        id: 'qwen3',
        name: 'Qwen 3',
        description: 'Recommended. Excellent reasoning and JSON generation.',
        capabilities: {
          supportsToolCalling: true,
          supportsToolStreaming: true,
          supportsObjectGeneration: true,
      ...
      },
      {
        id: 'llama3.2',
        name: 'Llama 3.2',
        description: 'Latest Llama, fast and capable.',
        capabilities: {
          supportsToolCalling: false,
          supportsToolStreaming: false,
          supportsObjectGeneration: true,
      ...
      },
      {
        id: 'mistral',
        name: 'Mistral',
        description: 'Strong reasoning. Good for structured output.',
        capabilities: {
          supportsToolCalling: false,
          supportsToolStreaming: false,
          supportsObjectGeneration: true,
      ...
      },
      {
        id: 'mixtral',
        name: 'Mixtral 8x7B',
        description: 'MoE architecture. Excellent for complex reasoning.',
        capabilities: {
          supportsToolCalling: false,
          supportsToolStreaming: false,
          supportsObjectGeneration: true,
      ...
      },
      {
        id: 'deepseek-r1',
        name: 'DeepSeek R1',
        description: 'Strong reasoning model. Great for conceptual analysis.',
        capabilities: {
          supportsToolCalling: false,
          supportsToolStreaming: false,
          supportsObjectGeneration: true,
      ...
      },
      {
        id: 'command-r',
        name: 'Command R',
        description: 'Cohere model. Good for structured generation.',
        capabilities: {
          supportsToolCalling: false,
          supportsToolStreaming: false,
          supportsObjectGeneration: true,
