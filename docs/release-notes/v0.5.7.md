...
This release fixes a significant performance issue with the Watcher Identity tabs in User Settings accessed via the Logged in user's Avatar in the upper right top bar. If you've noticed slow load times when switching between Movies and Series tabs, this one's for you!
