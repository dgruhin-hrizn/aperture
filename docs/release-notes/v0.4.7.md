...
The recommender now adapts explanation batch sizes based on your AI provider:
- **Ollama**: Smaller batches (5 items) for local LLM performance
- **Cloud providers**: Larger batches (15 items) for efficiency
