...
## ✨ New Feature: Advanced Discovery Filters
...
## 🐛 Fixed: Embedding Model Dimension Mismatch
...
- **Fixed resolutions endpoint** — Resolved an issue with the video resolutions API endpoint
